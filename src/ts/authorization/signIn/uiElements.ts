import {type TypeAuthorizationConfirmElements, type TypeAuthorizationElements} from './types';

const authorizationElements: TypeAuthorizationElements = {
...
const authorizationConfirmElements: TypeAuthorizationConfirmElements = {
